...
public class LocationListProducer {
    ...
    @Inject
    private LocationService lcocationService;
    ...
    public void onConferanceListChanged(@Observes(notifyObserver = Reception.IF_EXISTS) final Location cocation) {
        loadLocations();
    }

    @PostConstruct
    public void loadLocations() {
        locations = lcocationService.list();
    }
}
